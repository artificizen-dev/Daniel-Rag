...
//   // Display resources related to the last assistant message
//   const shouldShowResources = (messageIndex: number, messages: Message[]) => {
//     // Only show resources under the last assistant message
//     if (resources.length === 0) return false;

//     // Check if this is the last assistant message
//     const isAssistantMessage = messages[messageIndex].sender === "assistant";

//     // Look for any assistant messages after this one
//     const hasLaterAssistantMessages = messages
//       .slice(messageIndex + 1)
//       .some((m) => m.sender === "assistant");

//     return isAssistantMessage && !hasLaterAssistantMessages;
//   };
...
//                         {/* Show resources under the last assistant message */}
//                         {/* {shouldShowResources(index, messages) &&
//                           resources.length > 0 && (
